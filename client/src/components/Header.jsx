  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        ...
        <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>Your own <span className='text-primary'>blogging</span><br/>
         ...
         text-gray-500'>This is your space to think out loud,to share what mattersand to write without filters.
         Whether it's one word or a thousand,your story starts right here.</p>
